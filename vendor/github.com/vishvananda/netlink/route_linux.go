...
func RouteListTableId(link Link, tableId int, family int) ([]Route, error) {
	return pkgHandle.RouteListTableId(link, tableId, family)
}
func (h *Handle) RouteListTableId(link Link, tableId int, family int) ([]Route, error) {
