...
func LinkSetVlanTunnelOn(link Link, mode bool) error {
	return pkgHandle.LinkSetVlanTunnelOn(link, mode)
}

func (h *Handle) LinkSetVlanTunnelOn(link Link, mode bool) error {
